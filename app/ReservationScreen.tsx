...
export default function ReservationScreen() {
    ...
    useEffect(() => {
        socket = io(`http://10.130.218.95:3000` /*'https://d1lxguzc6q41zr.cloudfront.net'*/);
        ...
        const fetchRooms = async () => {
            ...
            try { 
                const response = await axios.get(`http://10.130.218.95:3000/getRooms/${placeID}`/*`https://d1lxguzc6q41zr.cloudfront.net/getRooms/${placeID}`*/);
    ...
    const handleSubmitReservation = async () => {
        ...
        try {
            const response = await axios.post(`http://10.130.218.95:3000/api/reservations`/*'https://d1lxguzc6q41zr.cloudfront.net/api/reservations'*/, {
                ...reservationDetails,
