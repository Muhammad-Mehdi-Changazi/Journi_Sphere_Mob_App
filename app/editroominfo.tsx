...
const EditRoomInfo = ({ hotel_id }: { hotel_id: string }) => {
    ...
    useEffect(() => {
        ...
        const fetchRooms = async () => {
            try {
                const response = await axios.get(`http://34.226.13.20:3000/${hotel_id}/rooms`/*`https://d1lxguzc6q41zr.cloudfront.net/${hotel_id}/rooms`*/);
    ...
    const handleUpdateRoom = async () => {
        ...
        try {
            const response = await axios.put(/*`https://d1lxguzc6q41zr.cloudfront.net/editroominfo/${selectedRoom._id}`*/ `http://34.226.13.20:3000/editroominfo/${selectedRoom._id}`, updatedRoom);
